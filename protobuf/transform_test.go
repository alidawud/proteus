...
import (
	...
	"github.com/alidawud/proteus/resolver"
...
func (s *TransformerSuite) TestTransform() {
	...
	s.Equal("github.com/alidawud/proteus/fixtures", pkg.Path)
	...
	s.Equal([]string{
		...
		"google/protobuf/timestamp.proto",
		"github.com/alidawud/proteus/fixtures/subpkg/generated.proto",
	}, pkg.Imports)
	...
	s.Equal("github.com/alidawud/proteus/fixtures/subpkg", pkg.Path)
...
const project = "github.com/alidawud/proteus"
